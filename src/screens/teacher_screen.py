...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder="@dhairya")
...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
    if not teacher_username or not teacher_name or not teacher_pass or not teacher_pass_confirm:
        return False, "All fields are require"
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder="@dhairya")
    teacher_name = st.text_input("Enter name", placeholder="Dhairya")
    teacher_pass = st.text_input("Enter password", type="password", placeholder="your password")
